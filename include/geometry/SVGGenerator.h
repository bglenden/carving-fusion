...
class SVGGenerator {
 ...
 public:
  ...
  void addTriArc(const TriArc& triArc, const std::string& color = "black", double strokeWidth = 1.0);
   ...
   * Add a line
   */
  void addLine(const Point2D& start, const Point2D& end, const std::string& color = "gray", double strokeWidth = 1.0,
               const std::string& style = "");

  /**
   * Add an arc path
   */
  void addArc(const Point2D& center, double radius, double startAngle, double endAngle, bool anticlockwise = false,
              const std::string& color = "blue", double strokeWidth = 1.0);

  /**
   * Add a circle (stroke only, not filled)
   */
  void addCircle(const Point2D& center, double radius, const std::string& color = "blue", double strokeWidth = 1.0);

  /**
   * Add text label
   */
  void addText(const Point2D& position, const std::string& text, const std::string& color = "black",
...
class SVGComparator {
 public:
   ...
   */
  static bool compare(const std::string& file1, const std::string& file2, double tolerance = DEFAULT_TOLERANCE);
   ...
   */
  static bool compareNumbers(const std::vector<double>& numbers1, const std::vector<double>& numbers2,
                             double tolerance);
};
