...
bool SVGComparator::compare(const std::string& file1, const std::string& file2,
                            double tolerance) {
...
std::vector<double> SVGComparator::extractNumbers(
...
bool SVGComparator::compareNumbers(const std::vector<double>& numbers1,
                                   const std::vector<double>& numbers2,
                                   double tolerance) {
