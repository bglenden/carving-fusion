...
void Leaf::drawToSketch(Adapters::ISketch* sketch, Adapters::ILogger* logger) const {
    ...
    // This fixes the issue where some leaf shapes appeared as crescents instead of footballs
...
// This method has been removed because it incorrectly used original shape parameters
